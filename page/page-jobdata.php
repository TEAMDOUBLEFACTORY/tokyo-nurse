<section class="p-jobdata" id="jobdata">
    <div class="p-jobdata__box c-contentbox main-color">
        <h2 class="info-item--head c-sec__title c-card02--title"><span
                class="c-sec__title--ja">少人数の実習で現場実践力を身につける！</span></h2>
    ...
    <div class="p-jobdata__box c-contentbox main-color">
        ...
        <h3 class="u-color-main c-contentbox--subtitle">丁寧な個別指導で、国家試験合格へ導く</h3>
        <p class="desc">
    ...
    <div class="p-jobdata__box c-contentbox main-color">
        <h2 class="info-item--head c-sec__title c-card02--title"><span class="c-sec__title--ja">就職のためのしっかりサポート</span>
        </h2>

        <h3 class="u-color-main c-contentbox--subtitle">確かなフォローで、希望の就職先へ</h3>
        <p class="desc">
            医療機関への就職について詳しいキャリア支援担当が的確にアドバイス。病院での実務経験があるベテラン教員が就職活動中の悩み相談にも乗り、<br>徹底的にサポートします。
        </p>
        <div class="c-graph">
            <h4>就職決定率</h4>
