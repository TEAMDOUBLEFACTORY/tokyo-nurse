<section class="p-voice" id="voice">
    ...
    <div class="p-voice__sec c-sec">
        ...
        <ul class="p-voice__list u-grid u-col-3">
            ...
            <li class="p-voice__listitem --dgreen">
                <h3 class="p-voice__listtitle --dgreen">駅近できれいな校舎に<br>安心できました</h3>
                <p class="p-voice__listtxt">校舎がきれいで駅から近くて良かったです。先生と生徒さんも仲良しで、サポートも充実していて魅力的だなと思いました。</p>
                <small class="p-voice__listname">Bさん　高校三年生</small>
            </li>
            <li class="p-voice__listitem">
            ...
            <li class="p-voice__listitem --dgreen">
                <h3 class="p-voice__listtitle --dgreen">アットホームな雰囲気の<br>学校だなと思いました</h3>
                <p class="p-voice__listtxt">アットホームな学校だと思いました！在校生の方や先生方も良い人たちで安心しました！</p>
                <small class="p-voice__listname">Dさん　既卒</small>
            </li>
            <li class="p-voice__listitem">
            ...
            <li class="p-voice__listitem">
                <h3 class="p-voice__listtitle">教員と生徒の距離が<br>近いと感じました</h3>
                <p class="p-voice__listtxt">思っていたより雰囲気がやわらかく、教職員と生徒の距離が近いと感じました。</p>
        ...
        <div class="p-voice__btn2"><a href="" class="c-btn c-btn--arrow">オープンキャンパスの開催日程はこちら</a>
        </div>
    </div>
    ...
    <div class="p-voice__sec c-sec">
        ...
        <div class="p-voice__btn2"><a href="" class="c-btn c-btn--arrow">入試説明会の開催日程はこちら</a>
        </div>
    </div>
</section>