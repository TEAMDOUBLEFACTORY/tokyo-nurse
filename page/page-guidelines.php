                ...
                <div class="p-admissions__info-list u-grid u-col-2 ">
                    <article class="info-item c-card02">
                        ...
                        <div class="info-item--text c-card02--text">
                            <p>WEB出願のポイントや、WEB出願の流れについて、<br class="pc">ご案内します。</p>
                        </div>
                        <div class="info-item__btn c-card02--btn"><a
                                href="<?php echo esc_url(home_url('/guidelines/web-entry/')); ?>"
                                class="c-btn__link">WEB出願について</a></div>
                    </article>
                    ...
                    <article class="info-item c-card02">
                        ...
                        <div class="info-item--text c-card02--text">
                            <p>学費と学費軽減のサポート制度をご案内します。<br class="pc">様々なサポート制度を整えておりますので、ご活用ください。</p>
                        </div>
                        <div class="info-item__btn c-card02--btn"><a
                                href="<?php echo esc_url(home_url('/guidelines/support/')); ?>"
                                class="c-btn__link">学費サポートについて</a></div>
                    </article>
            ...
            <div class="c-border-box c-sec">
                <div class="c-border-box__inner">
                    ...
                    <h3 class="u-color-main">
                        必ず自分に合った<br class="sp">入試方法が見つかる！<br>
                        入試プラン、学費の支払プランを<br class="sp">一緒に立てよう！
                    </h3>
                    <p>
                        ご相談内容に応じて、詳しい担当者が<br class="sp">個別に対応いたします。<br>クラス担当教員や学費について<br class="sp">相談できる担当者がおりますので<br
                            class="sp">入学後もお気軽にご相談ください。
                    </p>
